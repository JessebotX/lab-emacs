;;; simpc-mode.el -*- lexical-binding: t; -*-

;; Credit: https://github.com/rexim/simpc-mode/

;; License: MIT <https://github.com/rexim/simpc-mode/blob/master/LICENSE>

(require 'subr-x)

(defcustom simpc-indent-offset 3 
  "Default font size.")
...
(defun simpc--desired-indentation ()
  (let ((prev (simpc--previous-non-empty-line)))
    (if (not prev)
        (current-indentation)
      (let ((indent-len simpc-indent-offset)
